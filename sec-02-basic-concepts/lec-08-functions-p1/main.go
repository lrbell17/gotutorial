...
/*
A function is a collection of statements that allow us to reuse, organize, and abstract our code
*/
func printMessages(max int) {
	for x := 1; x <= max; x++ {
		fmt.Printf("This is message number %v of %v\n", x, max)
	}
}
...
func main() {
	...
	fmt.Printf("Items over $1500.00: %v\n", getItemsMoreThan(1500))
}
